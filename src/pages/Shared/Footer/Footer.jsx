...
const Footer = () => {
    return (
        <div className='bg-gray-800 text-gray-100' data-aos="fade-up" data-aos-duration="1000">
            <Container>
                <footer className="px-4 mt-32 divide-y dark:bg-gray-800 dark:text-gray-100">
                    <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                        <div className="lg:w-1/3">
                            <Link rel="noopener noreferrer" to="/" className="flex justify-center space-x-3 lg:justify-start">
                                <span className="self-center text-3xl font-bold">Launch<span className='text-orange-500'>Hub</span></span>
                            </Link>
                        </div>
                    ...
                    <div className="py-6 text-sm text-center dark:text-gray-400">© 2023 LaunchHub. All rights reserved.</div>
                </footer>
            </Container>
        </div>
    );
